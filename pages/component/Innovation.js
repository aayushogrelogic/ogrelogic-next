    ...
    return(
        <>
            <section className="container">
                <div className="px-3">
                    <h3 className="text-xl sm:text-2xl md:text-[26px] lg:text-3xl xl:text-4xl 2xl:text-[40px] lg:leading-8 xl:leading-9 2xl:leading-10 font-ttfirsNeueFontBold text-blue">Home to innovation</h3>
                    <p className="text-lg sm:text-[22px] md:text-2xl lg:text-[26px] xl:text-[28px] 2xl:text-3xl lg:leading-8 xl:leading-9 2xl:leading-10 max-w-[1116px] pt-7 sm:pt-8 md:pt-9 lg:pt-10 xl:pt-11 2xl:pt-[58px] font-montFontRegular font-medium">OgreLogic’s team of developers, designers, analysts and strategists know their trade well and utilize the power of technology to power native, hybrid, cross-platform app and web development.</p>
                </div>
                <div className="grid md:grid-cols-2 pt-[69px]">
                    <div className="bg-green py-5 px-8 2xl:py-16 2xl:px-[78px] ">
                        <h5 className="mb-5 sm:mb-6 md:mb-7 lg:mb-8 xl:mb-9 2xl:mb-10 text-4xl sm:text-[40px] md:text-4xl lg:text-[50px] max-w-fit xl:text-6xl 2xl:text-[70px] lg:leading-[50px] xl:leading-[60px] 2xl:leading-[70px] font-bold font-ttfirsNeueFontBold text-black/[50%] innovate-tab-active">Mobile</h5>
                        <h5 className="mb-5 sm:mb-6 md:mb-7 lg:mb-8 xl:mb-9 2xl:mb-10 text-4xl sm:text-[40px] md:text-4xl lg:text-[50px] max-w-fit xl:text-6xl 2xl:text-[70px] lg:leading-[50px] xl:leading-[60px] 2xl:leading-[70px] font-bold font-ttfirsNeueFontBold text-black/[50%]">Front End</h5>
                        <h5 className="mb-5 sm:mb-6 md:mb-7 lg:mb-8 xl:mb-9 2xl:mb-10 text-4xl sm:text-[40px] md:text-4xl lg:text-[50px] max-w-fit xl:text-6xl 2xl:text-[70px] lg:leading-[50px] xl:leading-[60px] 2xl:leading-[70px] font-bold font-ttfirsNeueFontBold text-black/[50%]">Database</h5>
                        <h5 className="mb-5 sm:mb-6 md:mb-7 lg:mb-8 xl:mb-9 2xl:mb-10 text-4xl sm:text-[40px] md:text-4xl lg:text-[50px] max-w-fit xl:text-6xl 2xl:text-[70px] lg:leading-[50px] xl:leading-[60px] 2xl:leading-[70px] font-bold font-ttfirsNeueFontBold text-black/[50%]">Backend</h5>
                        <h5 className="mb-5 sm:mb-6 md:mb-7 lg:mb-8 xl:mb-9 2xl:mb-10 text-4xl sm:text-[40px] md:text-4xl lg:text-[50px] max-w-fit xl:text-6xl 2xl:text-[70px] lg:leading-[50px] xl:leading-[60px] 2xl:leading-[70px] font-bold font-ttfirsNeueFontBold text-black/[50%]">CMS</h5>
                        <h5 className="text-4xl sm:text-[40px] md:text-4xl lg:text-[50px] max-w-fit xl:text-6xl 2xl:text-[70px] lg:leading-[50px] xl:leading-[60px] 2xl:leading-[70px] font-bold font-ttfirsNeueFontBold text-black/[50%]">Infra and Devops</h5>
                    </div>
